...
%                   20th Oct 2011 - Modified by Soumya Banerjee to
%                           validate text fields and added SSR field
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Last Modified by GUIDE v2.5 20-Oct-2011 18:05:21
...
sim_virus_vector = odecall_eclipse_tcl_jv_local(target,0,...
        0,log10(V0),log10(beta),log10(p),log10(delta),gamma,k,endtime,...
